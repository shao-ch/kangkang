...
import com.kangkang.utils.TXSmsUtils;
...
public class RedisConfig {
    ...
    public RedisTemplate<String,Object> redisTemplate(RedisConnectionFactory factory){
        ...
        LettuceConnectionFactory a= (LettuceConnectionFactory) factory;
        log.info("redisTemplate创建成功,  hostAdd="+a.getHostName()+":"+a.getPort());
    ...
    public RedisMessageListenerContainer container(RedisConnectionFactory connectionFactory) {
        ...
        //这里是监听0索引库下key过期的数据：__keyevent@0__:expired，key时间，0代表0索引库，后面的表示监听的是过期时间
